...
namespace cs
{
    ...
    {
        public static PlayerObjectController playerObjectController = null;
        ...
        private void Awake()
        {
            Debug.Assert(playerObjectController == null, "Error: There is more than one player in the scene, is this intentional?");
            playerObjectController = this;
            enableMovement = true;
        }
        ...
        {
            if (playerObjectController == this)
            {
